...
struct sCO_OD_RAM CO_OD_RAM = {
    ...
    /*1400*/ {{0x2L, 0x0181L, 0xffL},  // Justin: PDO setup that Rob created starts here (describes how the message is ID'd)
    ...
    /*1600*/ {{0x1L, 0x60410110L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L},  // This is the other half of the PDO setup pair to 1400 (describes the contents of the message)
              ...
              /*1610*/ {0x1L, 0x60030010L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L},  // Crutch parameters
              /*1611*/ {0x1L, 0x60040010L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L},  // Crutch parameters
              /*1612*/ {0x1L, 0x60050010L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L},  // Crutch parameters
              /*1613*/ {0x1L, 0x22020110L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L},  // Copley Drive motor1 amplifier temps
              /*1614*/ {0x1L, 0x22020210L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L},  // Copley Drive motor2 amplifier temps
              /*1615*/ {0x1L, 0x22020310L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L},  // Copley Drive motor3 amplifier temps
              /*1616*/ {0x1L, 0x22020410L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L},  // Copley Drive motor4 amplifier temps
              /*1617*/ {0x1L, 0x22020510L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L},  // Schneider Drive motor5 amplifier temps
              /*1618*/ {0x1L, 0x22020610L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L},  // Schneider Drive motor6 amplifier temps
    ...
    /*1a00*/ {{0x1L, 0x60400110L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L},
              ...
              /*1a1f*/ {0x0L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L}},  // End of section that Rob added
    /*1f80*/ 0x0000L,
    ...
    /*2202*/ {0x6L, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
...
/*0x2202*/ const CO_OD_entryRecord_t OD_record2202[7] = {
    {(void *)&CO_OD_RAM.motorAmpTemperatures.numberOfMotors, 0x06, 0x1},
    {(void *)&CO_OD_RAM.motorAmpTemperatures.motor1, 0xfe, 0x4},
    {(void *)&CO_OD_RAM.motorAmpTemperatures.motor2, 0xfe, 0x4},
    {(void *)&CO_OD_RAM.motorAmpTemperatures.motor3, 0xfe, 0x4},
    {(void *)&CO_OD_RAM.motorAmpTemperatures.motor4, 0xfe, 0x4},
    {(void *)&CO_OD_RAM.motorAmpTemperatures.motor5, 0xfe, 0x4},
    {(void *)&CO_OD_RAM.motorAmpTemperatures.motor6, 0xfe, 0x4},
};
